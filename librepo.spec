...
Version  : 1.14.4
Release  : 52
URL      : https://github.com/rpm-software-management/librepo/archive/1.14.4/librepo-1.14.4.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.14.4/librepo-1.14.4.tar.gz
...
%prep
%setup -q -n librepo-1.14.4
cd %{_builddir}/librepo-1.14.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661279647
mkdir -p clr-build
pushd clr-build

...
Version  : 1.18.0
Release  : 58
URL      : https://github.com/rpm-software-management/librepo/archive/1.18.0/librepo-1.18.0.tar.gz
Source0  : https://github.com/rpm-software-management/librepo/archive/1.18.0/librepo-1.18.0.tar.gz
...
%prep
%setup -q -n librepo-1.18.0
cd %{_builddir}/librepo-1.18.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721348917
mkdir -p clr-build
pushd clr-build
...
-DWITH_ZCHUNK=OFF \
-DENABLE_PYTHON=ON \
-DENABLE_SELINUX=OFF  -G 'Unix Makefiles'
make  %{?_smp_mflags}
popd
